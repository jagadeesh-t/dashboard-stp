...
class AddNewItemView extends React.Component {
  ...
  render () {
    ...
    return (
    <Touchable onPress={() => onPressItems('CreateNewMinistry')} style={{flex:1,flexDirection:'row'}}><Text style={{fontSize:25}}>Add </Text><RNIcon style={styles.add} size={styles.logoSize} name='plus' /></Touchable>
    );
  }
}
