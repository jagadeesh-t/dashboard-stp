...
describe('FormComponent: FormInput component', () => {
  ...
  describe('FormInput', () => {
    const wrapper = shallow(<FormInput value={'test value'} onInputChange={onInputChangeSpy} onBlur={onBlurSpy} onFocus={onFocusSpy} onChangeText={onChangeTextSpy} ref/>);
